// Landing page for Dra. Lucia Nosetti
// Original design — not recreating any branded company UI
...
function LogoChip({ label = 'LOGO' }) {
  return (
    <div style={{
      ...
      fontFamily: 'ui-monospace, "SF Mono", Menlo, monospace',
      fontSize: 9, color: 'rgba(44,31,34,0.7)', letterSpacing: 1,
      flexShrink: 0,
    }}>
      {label}
    </div>
  ...
  return (
    <nav style={{
      ...
      <div style={{
        ...
        <a href="#inicio" onClick={(e) => handleClick(e, '#inicio')} style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.1 }}>
            <span style={{
              ...
              fontWeight: 400, fontSize: 20, color: C.ink,
            }}>Dra. Lucia Nosetti</span>
            <span style={{
              fontSize: 11, color: C.pinkNude, letterSpacing: 1.2, textTransform: 'uppercase', marginTop: 2,
            }}>Dermatología · Estética</span>
          </div>
        </a>
        ...
        <div className="nav-links" style={{ display: 'flex', alignItems: 'center', gap: 28 }}>
          {links.map(([label, href]) => (
            <a key={href} href={href} onClick={(e) => handleClick(e, href)}
              style={{
                color: C.ink, textDecoration: 'none', fontSize: 14, fontWeight: 400,
  ...
  return (
    <section id="inicio" style={{
      ...
      <div className="float-slow" style={{
        ...
        border: `1.5px solid ${C.pink}`, opacity: 0.3, pointerEvents: 'none',
      }} />
      <div className="float-slow" style={{
        position: 'absolute', bottom: '12%', left: '-4%',
        width: 220, height: 220, borderRadius: '50%',
        border: `1.5px solid ${C.pinkNude}`, opacity: 0.25, pointerEvents: 'none',
        animationDelay: '-2s',
      }} />
      <div className="float-slow" style={{
        position: 'absolute', top: '40%', left: '38%',
        width: 110, height: 110, borderRadius: '50%',
        border: `1px solid ${C.pinkNude}`, opacity: 0.2, pointerEvents: 'none',
        animationDelay: '-4s',
      }} />
      ...
      <div className="container hero-grid" style={{
        ...
        <Reveal>
          <span style={{
            ...
            color: C.pinkNude, fontWeight: 500,
            background: 'rgba(255,255,255,0.7)',
          ...
          <p style={{
            fontSize: 18, lineHeight: 1.6, color: C.ink,
            maxWidth: 520, margin: '0 0 14px', fontWeight: 500,
            textAlign: 'justify',
          }}>
        ...
        <Reveal delay={150} style={{ position: 'relative' }}>
          ...
          <div className="float-slow" style={{
            ...
            boxShadow: C.shadowPink, border: `1px solid ${C.border}`,
  ...
  return (
    <section id="sobre-mi" style={{ background: '#fff', padding: '120px 0' }}>
      <div className="container about-grid" style={{
        ...
        <Reveal>
          <Placeholder label="[ FOTO_PERFIL ]" ratio="4/5" />
        </Reveal>
        <Reveal delay={120}>
            ...
            {[
              ...
              <Reveal key={i} delay={i * 80}>
                <div style={{
                  ...
                  <div style={{
                    fontFamily: "'Cormorant Garamond', serif",
                    fontSize: 32, color: C.pinkNude, fontWeight: 400, lineHeight: 1,
                  }}>{n}</div>
      ...
      {data.map(([title, desc], i) => (
        <Reveal key={title} delay={(i % 4) * 80}>
          <div className="proc-card" style={{
            ...
            <h3 style={{
              fontFamily: "'Cormorant Garamond', serif",
              fontSize: 22, fontWeight: 400, color: C.ink,
  ...
  return (
    <section id="procedimientos" style={{ background: C.altSection, padding: '120px 0', position: 'relative', overflow: 'hidden' }}>
      <div style={{
        ...
        background: `radial-gradient(circle, ${C.pinkSoft} 0%, transparent 70%)`, pointerEvents: 'none',
      }}/>
      <div style={{ maxWidth: 1240, margin: '0 auto', padding: '0 28px', position: 'relative' }}>
        <Reveal>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            <SectionTag center>Procedimientos</SectionTag>
        ...
        <Reveal>
          <div style={{ textAlign: 'center', marginTop: 100, marginBottom: 60 }}>
            <SectionTag center>Patologías</SectionTag>
            <h2 style={{ ...titleStyle, textAlign: 'center' }}>
...
function Formacion() {
  const timeline = [
    ['2017', 'Médica (MN 166.497)', 'Universidad del Salvador', 'LOGO_USAL'],
    ['2018–2021', 'Residencia de Pediatría', 'Hospital Alemán, CABA', 'LOGO_H_ALEMAN'],
    ['2022–2025', 'Residencia de Dermatología Pediátrica', 'Hospital Ramos Mejía, CABA', 'LOGO_RAMOS_MEJIA'],
  ];
  const exp = [
    'Hospital Alemán',
    'Sanatorio San José',
  ...
  return (
    <section id="formacion" style={{ background: '#fff', padding: '120px 0' }}>
      <div className="container form-grid" style={{
        maxWidth: 1240, margin: '0 auto', padding: '0 28px',
        ...
        <Reveal>
          ...
          <h2 style={titleStyle}>
            Trayectoria <em style={{ color: C.pinkNude, fontWeight: 400 }}>académica</em>
          </h2>

          <div style={{ position: 'relative', paddingLeft: 36, marginTop: 36 }}>
            <div style={{
              position: 'absolute', left: 11, top: 8, bottom: 8,
              width: 2, background: `linear-gradient(${C.pink}, ${C.pinkSoft})`,
            }} />
              ...
              <Reveal key={i} delay={i * 100}>
                <div style={{ position: 'relative', marginBottom: 36 }}>
                  <div style={{
                    ...
                    background: C.pinkNude,
                    border: `3px solid #fff`,
                    boxShadow: `0 0 0 2px ${C.pink}`,
                  }} />
                  <div style={{
                    fontSize: 12, color: C.pinkNude, fontWeight: 500,
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <LogoChip label={logo.replace('LOGO_', '').slice(0, 4)} />
              ...
              <Reveal key={place} delay={i * 70}>
                <div className="exp-card" style={{
                  ...
                  <div style={{
                    ...
                    background: C.pinkNude, flexShrink: 0,
                    boxShadow: `0 0 0 4px ${C.pinkSoft}`,
                  }} />
                  <div style={{ flex: 1 }}>
      ...
      <div style={{ maxWidth: 1240, margin: '0 auto', padding: '0 28px', textAlign: 'center' }}>
        ...
        <Reveal delay={120}>
          <div style={{
            ...
            padding: 12,
            boxShadow: '0 30px 60px -30px rgba(232,160,168,0.6)',
            border: `1px solid ${C.border}`,
          }}>
            <blockquote
              ...
              style={{
                background: '#FFF', border: 0, margin: '0 auto', maxWidth: 400, minWidth: 0, padding: 0, width: '100%',
              }}
            >
  ...
  return (
    <section id="turnos" style={{ background: '#fff', padding: '120px 0' }}>
      <div style={{ maxWidth: 1240, margin: '0 auto', padding: '0 28px' }}>
        <Reveal>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            <SectionTag center>Turnos</SectionTag>
            <h2 style={{ ...titleStyle, textAlign: 'center' }}>
        ...
        <div className="turnos-grid" style={{
          display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, maxWidth: 1000, margin: '0 auto',
        }}>
          <Reveal>
            <div style={{
              background: C.altSection,
              border: `1px solid ${C.border}`,
              borderRadius: 18, padding: '36px 34px', height: '100%',
            }}>
              <h3 style={{
                fontFamily: "'Cormorant Garamond', serif",
                fontSize: 28, fontWeight: 400, color: C.ink, margin: '0 0 8px',
              }}>Consultorio en Recoleta</h3>
              <p style={{ color: C.inkMuted, fontSize: 15, margin: '0 0 8px' }}>{ADDRESS}</p>
              <a href={MAPS} target="_blank" rel="noreferrer" style={{
                color: C.pinkNude, fontSize: 14, fontWeight: 500, textDecoration: 'none',
                display: 'inline-flex', alignItems: 'center', gap: 6,
                borderBottom: `1px solid ${C.pink}`, paddingBottom: 2,
              }}>Ver en Google Maps →</a>

              <div style={{ marginTop: 28, paddingTop: 24, borderTop: `1px solid ${C.border}` }}>
                <div style={{
                  fontSize: 11, letterSpacing: 2, textTransform: 'uppercase',
                  color: C.pinkNude, fontWeight: 500, marginBottom: 14,
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                  {horarios.map(([dia, hora], i) => (
                    <div key={i} style={{
                      ...
                      padding: '12px 0',
                      borderBottom: i < horarios.length - 1 ? `1px dashed ${C.border}` : 'none',
                    }}>
          ...
          <Reveal delay={120}>
            <div style={{
              background: '#fff',
              border: `1px solid ${C.border}`,
              borderRadius: 18, padding: '40px 34px', height: '100%',
              display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
              textAlign: 'center',
              boxShadow: C.shadowPink,
            }}>
              <div className="float-slow" style={{
              ...
              <h3 style={{
                fontFamily: "'Cormorant Garamond', serif",
                fontSize: 30, fontWeight: 400, color: C.ink, margin: '0 0 10px',
              }}>Solicitá tu turno</h3>
              <p style={{ color: C.inkMuted, fontSize: 15, margin: '0 0 26px', maxWidth: 320, lineHeight: 1.55 }}>
              ...
              <p style={{ color: C.inkMuted, fontSize: 12.5, margin: '20px 0 0', fontStyle: 'italic' }}>
...
function Consultas() {
  ...
  const submit = async (e) => {
    e.preventDefault();
    setStatus('sending');
    // TODO: reemplazar GOOGLE_SCRIPT_URL con tu URL de Apps Script
    ...
    try {
      if (GOOGLE_SCRIPT_URL) {
        ...
        // Simular envío mientras no hay endpoint real
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '0 28px' }}>
        <Reveal>
          <div style={{ textAlign: 'center', marginBottom: 50 }}>
            <SectionTag center>Contacto</SectionTag>
            <h2 style={{ ...titleStyle, textAlign: 'center' }}>
        ...
        <Reveal delay={100}>
          <form onSubmit={submit} style={{
            ...
            border: `1px solid ${C.border}`,
            boxShadow: '0 30px 60px -30px rgba(232,160,168,0.45)',
          }}>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <textarea className="ff" required rows={4} value={form.consulta} onChange={update('consulta')}
            ...
            {status === 'success' && (
              <div style={{
                ...
                background: C.pinkSoft, color: C.ink, fontSize: 14, textAlign: 'center',
...
function FinalCTA() {
  return (
    <section style={{
      padding: '120px 28px',
      background: `radial-gradient(ellipse at center, ${C.pinkSoft} 0%, ${C.pink}55 35%, #fff 80%)`,
      textAlign: 'center', position: 'relative', overflow: 'hidden',
    }}>
      <div className="float-slow" style={{
        position: 'absolute', top: '20%', left: '8%',
        width: 180, height: 180, borderRadius: '50%',
        border: `1px solid ${C.pinkNude}`, opacity: 0.3,
      }} />
      <div className="float-slow" style={{
        position: 'absolute', bottom: '15%', right: '10%',
        width: 140, height: 140, borderRadius: '50%',
        border: `1px solid ${C.pink}`, opacity: 0.4,
        animationDelay: '-3s',
      }} />
      <Reveal>
        <h2 style={{
          fontFamily: "'Cormorant Garamond', serif",
          fontWeight: 300, fontSize: 'clamp(40px, 5vw, 64px)',
          color: C.ink, margin: '0 0 18px', lineHeight: 1.1,
        }}>
          ¿Querés <em style={{ color: C.pinkNude, fontWeight: 400 }}>pedir un turno?</em>
        </h2>
        <p style={{ color: C.inkMuted, fontSize: 18, margin: '0 0 36px', fontWeight: 300 }}>
          Escribinos por WhatsApp y coordinamos.
        </p>
...
function Footer() {
  const links = [
    ['Instagram', IG_LINK,
      <svg key="i" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        <rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="0.8" fill="currentColor"/>
      </svg>
    ],
    ['LinkedIn', LI_LINK,
      <svg key="l" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        <rect x="3" y="3" width="18" height="18" rx="3"/><path d="M8 10v7M8 7v.01M12 17v-4a2 2 0 0 1 4 0v4M12 17v-7"/>
      </svg>
    ],
    ['WhatsApp', `https://wa.me/541169323425`,
      <svg key="w" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path d="M20.5 3.5A10 10 0 0 0 4.1 16.6L3 21l4.5-1.2a10 10 0 0 0 13-15.3z" strokeLinejoin="round"/>
      </svg>
    ],
    ['Email', `mailto:${MAIL}`,
      <svg key="m" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  return (
    <footer style={{
      background: '#fff', borderTop: `1px solid ${C.pink}`,
      padding: '40px 28px',
    }}>
      <div style={{
...
function SectionTag({ children, center }) {
  return (
    <span style={{
      ...
      color: C.pinkNude, fontWeight: 600,
      background: C.altSection,
      border: `1px solid ${C.border}`,
  ...
  return (
    <React.Fragment>
      <style>{`
        ...
        a, button { font-family: 'Nunito', system-ui, sans-serif; }
        @keyframes float {
        ...
        .btn-primary {
          ...
          box-shadow: 0 10px 24px -10px rgba(232,160,168,0.7);
          letter-spacing: 0.3px;
        }
        .btn-primary:hover {
          transform: translateY(-2px);
          box-shadow: 0 16px 30px -12px rgba(232,160,168,0.8);
          background: #d8939c;
        }
        .btn-outline {
          display: inline-block;
        ...
        .proc-card:hover {
          ...
          box-shadow: 0 20px 40px -20px rgba(232,160,168,0.55);
          border-color: #F2C4CE;
        }
        .exp-card:hover {
          transform: translateY(-3px);
          box-shadow: 0 16px 30px -16px rgba(232,160,168,0.4);
        }
        ...
        .ff:focus {
          ...
          box-shadow: 0 0 0 4px #F9E0E5 !important;
        }
        ...
        @media (max-width: 960px) {
          ...
          .hero-grid, .about-grid, .form-grid, .turnos-grid {
